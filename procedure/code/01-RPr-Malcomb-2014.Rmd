...
**Reanalysis change**: These new colors are shades of the past colors. This may assist with viewing some of the lighter values (closer to 0). I used the website Color-Hex (https://www.color-hex.com/) to help with choosing darker colors.
...
A primary topic of discussion ought to be the direct comparisons made between the adaptive capacity and vulnerability maps for the reproduction study and the original study. Both comparison figures present large differences, likely reflecting in some ways the deviations from the original study which were pursued to reduce uncertainty. It is clear that for many TAs, there is a difference in adaptive capacity whereby the reproduction of Figure 4 has a value in the natural break below the break in which the corresponding value for the original figure appeared. This inconsistency could be a result of the planned deviations outlined above related to normalization, weighting, and aggregation of household-level adaptive capacity data (Tate 2013), for there was a perceived lack of clarity in these steps in original study. The pattern of values with a -1 placement in adaptive capacity natural break when comparing the reproduction to the original is spread across the country. It is also worth noting that the reproduction almost never resulted in adaptive capacity values which were in the natural break above the one in which the corresponding value for the original figure, and there were few instances of a -2 difference in natural break. Those TAs which have missing values can be interpreted as lacking due to the measurement error (Tate 2013) of the original study relating to the lake geometry.

The comparison figure based on Figure 5, or the vulnerability assessment, is similarly indicative of a reproduction that differs greatly from the original results of the analysis. The values for vulnerability are seen to be lower in the reproduction compared to the original assessment for much of the country, including around the area corresponding to the Southern Lakeshore livelihood zone. There are select areas - including the north of the country and possibly part of the Lower Shire Valley - where vulnerability values are greater in the reproduction than the original. However, this pattern is more sparse than the substantial percentage of the country which appears to have a negative difference when taking the reproduction less the original. This initially draws comparisons to the pattern seen in the comparison figure based upon Figure 4, but the vulnerability calculations also addressed the uncertainty in the scaling methodology for the original study as well as the validity of the vulnerability equation itself. Altering the equation such that physical exposure is inverted was a planned deviation to obtain an equation which better represents other vulnerability assessments in the literature; adaptive capacity is often included as a value which is subtracted from a value, which is the inversion of its usage in the equation from the original study (Prof. Holler, personal communication, 10/19/2023). The vulnerability equation clearly represents a lack of consistency in that the authors state it to refer to household resilience, yet resilience is what is being mapped in Figure 4, a map which this reproduction has already established should refer to adaptive capacity (Assets + Access). This complicates an analysis of the work of Malcomb et al., and it necessitated deviations in labeling (Figure 4 is for adaptive capacity and Figure 5 is for vulnerability, not resilience) for this reproduction. The deviations related to the equation or normalization (Tate 2013) may have impacted the results, leading to the large differences in vulnerability in the comparison figure.
...
# Conclusions
It would be difficult to classify this reproduction as a success due to the differences between the figures produced by the data and the ones seen in the original paper; in particular, it has been shown that the final vulnerability map (Figure 5) contrasts greatly with the original. As Malcomb et al. write in their conclusion that their maps could have relevance in Malawian policy, that the vulnerability map is so different to the reproduction is troubling for the internal consistency of the authors' approach. It is worth noting, however, that this negative judgement of success and internal consistency is likely somewhat related to the deviations which were deemed necessary to address the fairly unclear nature of the terminology and normalization scheme of the original study and may not be as related to difficulties in obtaining or processing the data. In sum, a close reproduction of the values in Figures 4 and 5 were not achieved. This reproduction study can thus not be classified as a full success.
